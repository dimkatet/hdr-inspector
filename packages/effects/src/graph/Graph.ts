...
import { makeNodeId, type Connection, type NodeId } from '../types'
...
const NODE_FACTORIES = new Map<NodeTypeTag, NodeFactory>([
  ['source', (p) => ({ type: 'source', outputType: 'rgba', inputPorts: [] as const, params: p as unknown as TextureInputParams })],
  ['noise.2d', (p) => ({ type: 'noise.2d', outputType: 'scalar', inputPorts: [] as const, params: p as unknown as Noise2DParams })],
  ['noise.fbm', (p) => ({ type: 'noise.fbm', outputType: 'scalar', inputPorts: [] as const, params: p as unknown as FBMParams })],
  ['geometry.warp', (p) => ({ type: 'geometry.warp', outputType: 'rgba', inputPorts: ['image', 'field'] as const, params: p as unknown as WarpParams })],
  ['geometry.transform', (p) => ({ type: 'geometry.transform', outputType: 'rgba', inputPorts: ['image'] as const, params: p as unknown as TransformParams })],
  ['color.transform', (p) => ({ type: 'color.transform', outputType: 'rgba', inputPorts: ['image'] as const, params: p as unknown as ColorTransformParams })],
  ['color.gradientMap', (p) => ({ type: 'color.gradientMap', outputType: 'rgba', inputPorts: ['luminance'] as const, params: p as unknown as GradientMapParams })],
  ['channel.offset', (p) => ({ type: 'channel.offset', outputType: 'rgba', inputPorts: ['image'] as const, params: p as unknown as ChannelOffsetParams })],
  ['channel.mix', (p) => ({ type: 'channel.mix', outputType: 'rgba', inputPorts: ['a', 'b'] as const, params: p as unknown as ChannelMixParams })],
  ['utility.mix', (p) => ({ type: 'utility.mix', outputType: 'rgba', inputPorts: ['a', 'b', 'factor'] as const, params: p as unknown as MixParams })],
  ['utility.mask', (p) => ({ type: 'utility.mask', outputType: 'rgba', inputPorts: ['image', 'mask'] as const, params: p as unknown as MaskParams })],
  ['utility.math', (p) => ({ type: 'utility.math', outputType: 'scalar', inputPorts: ['a', 'b'] as const, params: p as unknown as MathParams })],
])
